...
if(d2c == 1):
    rgb_path = "/home/u22/kyz/mycalibrate/fairautocalibrate/received_data/color_000_1769409442.jpg"
    depth_path = "/home/u22/kyz/mycalibrate/fairautocalibrate/received_data/depth_u16_000_1769409443.png"
    # 使用手眼标定时得到的相机内参（与标定一致）
    intrinsics = (601.85552584, 601.10594863, 641.45224297, 401.85953898)  # fx, fy, cx, cy
    x,y,z = d2crun(rgb_path, depth_path, intrinsics) # 获取点击的3D坐标，单位毫米
    print('clicked point in color camera coordinates (mm):', x,y,z)
    x,y,z=x/1000.0,y/1000.0,z/1000.0 # 转换为米
    error,tcp=robot.GetActualTCPPose()
    print('robot tcp pose:', tcp)
